...
|----------|---------|----------------|
| **Financial** | GDP, Gov. debt, Inflation, Interest rate, Unemployment rate, Poverty headcount | World Bank WDI, IMF WEO |
| **Population** | Total, Age groups (0–14, 15–64, 65+) | World Bank WDI |
| **Health** | Life expectancy, under‑5 mortality, maternal mortality, undernourishment | World Bank WDI, FAO, UN / WHO via WDI |
...
| `unemploymentRate` | Unemployment rate (% of labour force) | % of labour force | (Unemployed persons / Total labour force) × 100 | — (modeled ILO estimate via WDI) |
...
| `under5MortalityRate` | Under‑5 mortality rate | Per 1,000 live births | Probability per 1,000 that a newborn will die before age five, given current age‑specific mortality rates |
...
| Poverty headcount ($2.15/day, % of population) | SI.POV.DDAY |
| Poverty headcount (national poverty line, % of population) | SI.POV.NAHC |
