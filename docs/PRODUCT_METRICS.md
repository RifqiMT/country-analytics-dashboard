...
- **Porter 5 Forces**: Uses selected country context and global data (DATA_MAX_YEAR) plus a chosen ILO/ISIC industry division; supplemental web search (TAVILY first, then GROQ) enriches the analysis. All citations and sources are inline in the narrative.
