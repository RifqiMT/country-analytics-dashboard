...
| Document | Description |
|----------|-------------|
| [ARCHITECTURE.md](ARCHITECTURE.md) | **Data flow and component architecture** – high-level flow, Country Dashboard and Global data flow, Analytics Assistant flow (TAVILY supplement, GROQ, others), **Porter 5 Forces flow** (TAVILY supplement, GROQ, inline citations), component hierarchy (timelines, PESTEL with PNG exports, **Porter5ForcesSection**, Global Charts, Business Analytics, Source, Chat), API layer, fallbacks (territory, Taiwan). |
