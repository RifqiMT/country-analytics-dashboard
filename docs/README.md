...
| [METRICS_AND_OKRS.md](METRICS_AND_OKRS.md) | **Product metrics and OKR metrics** – north-star and core engagement metrics, feature-level metrics (Country, Global incl. **region filter** GR-1, Source, PESTEL incl. chart exports, **Porter 5 Forces**, **Business Analytics** incl. year range and exclude-outliers usage, Analytics Assistant), OKR objectives and key results for the product team, instrumentation guidelines (incl. **global.region_filter_changed**), product team cadence. |
