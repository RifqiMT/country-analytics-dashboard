...
- Always show project association on task cards when `projectId` is present.
- If the project is deleted, tasks should gracefully fall back to “All tasks”.
...
- **Voice input**:
  ...
  - avoid blocking save if voice parsing fails
...
- Prefer short action labels:
  - “New”, “Save”, “Cancel”, “Move”, “Delete”, “Export”
- Confirm destructive actions with clear scope:
