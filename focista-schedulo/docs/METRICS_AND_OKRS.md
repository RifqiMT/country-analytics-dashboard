...
- Until user identity/telemetry exists, treat these as **local-product goals** and validate through QA scenarios and manual instrumentation.
...
- **G1**: Recurrence correctness stays ≥ 99.5%
- **G2**: ID stability stays ≥ 99.9%
...
- Define import schema and conflict strategy (merge vs overwrite vs new workspace)
- Add validation + preview prior to import
