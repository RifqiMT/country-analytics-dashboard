...
export function TimeSeriesSection({
  ...
  const allSeries: MetricSeries[] = [
    ...
    // Exclude population age-group share series from this timeline to keep the view focused.
  ...
  const CustomTooltip = ({
    ...
    const byMetricId = new Map<
      string,
      { name: string; value: number; color: string; change?: string; changeDirection?: 'up' | 'down' | 'flat' }
    >();
