...
const IN_SCOPE_TERMS = /\b(gdp|population|inflation|debt|life\s+expectancy|area|eez|ranking|compare|top\s+\d+|metric|data\s+source|methodology|how\s+is\s+\w+\s+calculated|world\s+bank|imf|education|unemployment|labour|labor)\b/i;
